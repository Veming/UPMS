    ...
    <div class="row">
        ...
        <div id="content" class="col-md-12 full-page login">
            ...
            <div class="welcome">
                ...
                <h1><strong>Welcome</strong> NEW USER</h1>
                <h5>UPMS v. 0.1</h5>

                <form id="form-signin" class="form-signin" action="/register.html" method="post">
                    <section>
                    ...
                    <section class="new-acc">
                        <button class="btn btn-greensea" onclick="register()">submit</button>
                    </section>
                </form>
            </div>
            ...
            <a href="/login.html" class="log-in" readonly="readonly">log In<i class="fa fa-arrow-right fa-5x"></i></a>
...
<script type="text/javascript">
    function register() {
        if ("" ==mobile.value ){
            ...
            document.forms[0].action="/register.html?method=register";
