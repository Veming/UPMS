					...
					<div class="main">
						...
						<section class="tile">
							...
							<div class="tile-body">
								...
								<form class="form-horizontal" role="form" action="editOperationInfo.jsp">

									<div class="form-group">
										<label for="oname" class="col-sm-4 control-label">公司名称</label>
										<div class="col-sm-4">
											<input type="text" class="form-control" id="oname" name="oname" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										<label for="gen_time" class="col-sm-4 control-label">创建时间</label>
										<div class="col-sm-4">
											<input type="text" class="form-control" id="gen_time" name="gen_time" readonly="readonly">
										</div>
									</div>

									<div class="form-group">
										<label for="input05" class="col-sm-4 control-label">公司描述</label>
										<div class="col-sm-4">
											<textarea class="form-control" id="input05" rows="5" readonly="readonly"></textarea>
										</div>
									</div>

									<div class="form-group form-footer">
										<div class="col-sm-offset-4 col-sm-8">
											<button type="submit" class="btn btn-default" >修改公司信息</button>
										</div>
									</div>
