                    ...
                    <div class="tile-body">
                        ...
                        <form class="form-horizontal" role="form" action="#" method="post">
                            ...
                            <div class="form-group">
                                <label for="input01" class="col-sm-4 control-label">员工姓名</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="oname" name="oname" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="input01" class="col-sm-4 control-label">登录账号</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="oname" name="oname" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="input01" class="col-sm-4 control-label">用户密码</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="oname" name="oname" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="input01" class="col-sm-4 control-label">手机号</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="oname" name="oname" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="input01" class="col-sm-4 control-label">用户邮箱</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="oname" name="oname" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="input01" class="col-sm-4 control-label">用户角色</label>
                                <div class="col-sm-4">
