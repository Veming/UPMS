      ...
      <div class="main">
        <section class="tile cornered">
          ...
          <div class="tile-header transparent">
            <h1><strong>角色</strong> 列表</h1>
            <div class="controls">
              <a href="#" class="refresh"><i class="fa fa-refresh"></i></a>
              <a href="#" class="remove"><i class="fa fa-times"></i></a>
            </div>
          </div>
          <form class="form-horizontal" role="form" action="/role.html?method=search" method="post">
            <div class="form-group">
              <label for="rname" class="col-sm-2 control-label">角色查询</label></label>
              <div class="col-sm-2" style="width: 30%;">
                <input type="text" class="form-control" id="rname" name="rname" style="width: 70%; margin-right: 0;" />
                <button type="submit" class="btn btn-primary" style="width: 32%; top: 0; right: 0; position: absolute; height: 37px;">Submit</button>
              </div>
            </div>
          </form>
          <div class="action text-center" style="margin-left: 80%;"><a href="/role.html?method=toAdd">AddRole</a></div>
          <div class="tile-body nopadding">
            ...
            <div class="table-responsive">
              <table  class="table table-datatable table-bordered" id="inlineEditDataTable">
                <thead>
                <tr>
                  <th class="sort-alpha">角色名称</th>
                  <th class="sort-alpha">创建时间</th>
                  <th class="sort-amount">角色描述</th>
                  <th class="sort-amount">角色权限查看</th>
                ...
                <c:forEach var="role" items="${roles}">
                  <tr class="odd gradeX">
                    <td>${role.rname}</td>
                    <td><fmt:formatDate value="${role.gen_time}"  type="both" /></td>
                    <td>${role.description}</td>
                    <td class="text-center"><a href="/roleFunction.html?rid=${role.rid}">查看权限</a></td>

                    <td class="actions text-center"  width="150px">
                      <a class="edit" href="/role.html?method=toEdit&rid=${role.rid}">Edit</a>
                      <a class="delete" href="/role.html?method=delete&rid=${role.rid}">Delete</a>
                    </td>
                  </tr>
