      ...
      <div class="main">
        <section class="tile cornered">
          ...
          <div class="tile-header transparent">
            <h1><strong>“${role.rname}”</strong>角色功能列表</h1>
            <div class="controls">
          ...
          <form action="/roleFunction.html?method=add" method="post" style="margin-left: 80%;">
            <div class="btn-group margin-bottom-20">
              <select class="btn btn-default dropdown-toggle" name="fid">
                ...
                <c:forEach items="${allFunctions}" var="function">
                  <option value="${function.fid}">${function.fname}</option>
                </c:forEach>
              </select>
              <input type="hidden" name="rid" value="${role.rid}">
              <input style="margin-left:10px; margin-top:3px ;" type="submit" value="AddFunction"/>
            </div>
          </form>
          ...
          <div class="tile-body nopadding">
            ...
            <div class="table-responsive">
              <table class="table table-datatable table-bordered" id="inlineEditDataTable">
                ...
                <c:forEach items="${roleFunctions}" var="roleFunction">
                  <tr class="odd gradeX">
                    <td>${roleFunction.fname}</td>
                    <td>${roleFunction.description}</td>
                    <td class="actions text-center" width="150px">
                      <a class="delete" href="/roleFunction.html?method=delete&fid=${roleFunction.fid}&rid=${role.rid}">Delete</a>
                    </td>
                  </tr>
                </c:forEach>
