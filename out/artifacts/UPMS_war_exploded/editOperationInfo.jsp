							...
							<div class="tile-body">
								...
								<form class="form-horizontal" role="form" action="#" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" id="oname" name="oname" value="${organization.oname}">
										</div>
									</div>
									<div class="form-group">
										<label for="gen_time" class="col-sm-4 control-label">创建时间</label>
										<div class="col-sm-4">
											<input type="text"  name="gen_time" value="${organization.gen_time}" onmousemove="WdatePicker({dateFmt:'yyyy-MM-dd'})" >
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<textarea class="form-control" id="description" rows="3" value=""></textarea>
										</div>
									</div>
