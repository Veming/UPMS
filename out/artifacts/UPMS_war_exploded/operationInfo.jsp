					...
					<div class="main">
						...
						<section class="tile">
							...
							<div class="tile-body">
								...
								<form class="form-horizontal" role="form" action="/organization.html?method=toEdit" method="post">

									<div class="form-group">
										<label for="oname" class="col-sm-4 control-label">公司名称</label>
										<div class="col-sm-4">
											<li id="oname">${organization.oname}</li>
										</div>
									</div>
									<div class="form-group">
										<label for="gen_time" class="col-sm-4 control-label">创建时间</label>
										<div class="col-sm-4">
											<li id="gen_time"><fmt:formatDate value="${organization.gen_time}"  type="both" /></li>
										</div>
									</div>

									<div class="form-group">
										<label for="description" class="col-sm-4 control-label">公司描述</label>
										<div class="col-sm-4">
											<li id="description">${organization.description}</li>
										</div>
									</div>
