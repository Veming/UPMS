						...
						<div class="row">
							...
							<section class="tile">
								...
								<div class="action text-center" style="margin-left:80%;">
									<a href="/user.html?method=toAdd">AddEmplyee</a>
								</div>
								<!-- tile body -->
												...
												<tr class="odd gradeX">
													...
													<td>
														<c:forEach var="role" items="${roles}">
															<c:if test="${ role.rid == user.rid}">${role.rname}</c:if>
														</c:forEach>
													</td>
													<td><fmt:formatDate value="${user.gen_time}"  type="both" /></td>
													<td><fmt:formatDate value="${user.login_time}"  type="both" /></td>
													<td><fmt:formatDate value="${user.last_login_time}"  type="both" /></td>
													<td>${user.count}</td>
