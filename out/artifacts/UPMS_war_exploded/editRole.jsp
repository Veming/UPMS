            ...
            <div class="main">
                ...
                <section class="tile">
                    ...
                    <div class="tile-body">
                        ...
                        <form class="form-horizontal" role="form" action="/role.html?method=edit" method="post">

                            <div class="form-group">
                                <label for="rname" class="col-sm-4 control-label">角色名称</label>
                                <div class="col-sm-4">
