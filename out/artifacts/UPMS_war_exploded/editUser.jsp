            ...
            <div class="main">
                ...
                <section class="tile">
                    ...
                    <div class="tile-body">
                        ...
                        <form class="form-horizontal" role="form" action="/user.html?method=add" method="post">
                            ...
                            <div class="form-group">
                                <label for="rid" class="col-sm-4 control-label">用户角色</label>
                                <div class="col-sm-4">
                                    <select name="rid" id="rid" class="col-sm-5 control-label">
                                        <c:forEach var="role" items="${roles}">
                                        <option value="${role.rid}"  <c:if test="${ role.rid == user.rid}"> selected="selected"</c:if>  >${role.rname}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
